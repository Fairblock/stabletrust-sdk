 ...
 * @param {string} randomness_base64
 * @returns {string}
 */
export function decrypt_ciphertext_with_randomness(ciphertext_base64, randomness_base64) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ptr1 = passStringToWasm0(randomness_base64, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len1 = WASM_VECTOR_LEN;
        wasm.decrypt_ciphertext_with_randomness(retptr, ptr0, len0, ptr1, len1);
 ...
 * @returns {string}
 */
export function encrypt_amount_with_randomness(amount, pubkey_base64) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.encrypt_amount_with_randomness(retptr, amount, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
